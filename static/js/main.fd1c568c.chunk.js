...
`,Gt=c.c.span`
  font-weight: bold;
  color: ${e=>e.color?((e,t=!0)=>{const n=`${e}:${t}`;if(Ot.has(n))return Ot.get(n);if(!/^#[0-9a-f]+$/i.test(e))return e;let a;for(let r=20;r>=0&&(a=yt(e),"light"!==a||t)&&("dark"!==a||!t);r-=1)e=wt(e,a);return Ot.set(n,e),Ot.size>1e3&&Ot.delete(Ot.entries().next().value[0]),e})(e.color):null};
  cursor: pointer;
`,Ht=c.c.img`
  display: inline-block;
  margin-top: -5px;
