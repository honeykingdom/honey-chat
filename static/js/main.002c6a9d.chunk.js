...
`,wt=c.c.img`
  ...
  ${Bt} + &[data-emote-id='5849c9a4f52be01a7ee5f79d'] {
    margin-left: -33px;
  }

  /* SoSnowy */
  &        + &[data-emote-id='567b5b520e984428652809b6'],
  ${Bt} + &[data-emote-id='567b5b520e984428652809b6'] {
    margin-left: -32px;
  }

  /* SantaHat */
  &        + &[data-emote-id='58487cc6f52be01a7ee5f205'],
  ${Bt} + &[data-emote-id='58487cc6f52be01a7ee5f205'] {
    margin-left: -34px;
    margin-top: -18px;
  }
  ...
  ${Bt} + &[data-emote-id='5849c9c8f52be01a7ee5f79e'],
  &        + &[data-emote-id='567b5c080e984428652809ba'],
  ${Bt} + &[data-emote-id='567b5c080e984428652809ba'],
  &        + &[data-emote-id='567b5dc00e984428652809bd'],
  ${Bt} + &[data-emote-id='567b5dc00e984428652809bd'] {
    margin-left: -31px;
    margin-top: -18px;
  }
  ...
  ${Bt} + &[data-emote-id='5e76d338d6581c3724c0f0b2'],
  &        + &[data-emote-id='5e76d399d6581c3724c0f0b8'],
  ${Bt} + &[data-emote-id='5e76d399d6581c3724c0f0b8'] {
    margin-left: -34px;
    height: 34px;
    width: 34px;
  }
...
`;var Lt=({onNameRightClick:e})=>{const[t,n]=Object(a.useState)(!1),r=Object(i.c)(v.u),s=Object(i.c)(l.h),o=Object(i.c)(v.n),c=Object(i.c)(m),d=Object(i.c)(g),b=Object(a.useRef)(null),f=()=>{b.current&&b.current.scrollToBottom()};Object(a.useEffect)(()=>{t||f()},[r]);const h=e=>!!d&&(o?e%2===1:e%2===0);return u.a.createElement($t,null,u.a.createElement(Mt,{onUpdate:({clientHeight:e,contentScrollHeight:t,scrollTop:a})=>{n(a+100<t-e)},ref:b},r.map((t,n)=>u.a.createElement(Nt,{key:t.id,message:t,userLogin:s,isEven:h(n),isShowTimestamps:c,onNameRightClick:e}))),u.a.createElement(Ut,{onClick:f,isVisible:t},"More messages below"))};const Gt=c.c.div`
  padding: 10px;
  flex-grow: 1;
  width: 320px;
`,Ht=c.c.h2`
...
`,Kt=Object(c.c)(qe)`
  flex-shrink: none;
`;var Vt=()=>{const e=Object(s.f)(),[t,n]=Object(a.useState)(""),r=Object(a.useRef)(null);Object(a.useEffect)(()=>{r.current&&r.current.focus()},[]);const o=()=>{e.push({pathname:"/chat/",hash:t})};return u.a.createElement(Gt,null,u.a.createElement(Ht,null,"Channel to join: "),u.a.createElement(Wt,null,u.a.createElement(Jt,{ref:r,value:t,onChange:e=>n(e.target.value),onKeyPress:e=>{"Enter"===e.key&&o()}}),u.a.createElement(Kt,{onClick:o,disabled:!t},"Join")))};const qt=c.c.div`
  height: 100vh;
  font-size: 12px;
...
`,Yt=c.c.div`
  ...
  height: 100%;
  background-color: #18181b;
`;var Zt=()=>{const[e,t]=Object(a.useState)(""),n=I();E(),x(),C();const r=Object(i.c)(v.d),s=Object(i.c)(l.f),o=Object(i.c)(v.l),c=Object(i.c)(b),d=Object(a.useRef)(null),m=Object(a.useRef)(e);m.current=e;const g=!s||!o,f=Object(a.useCallback)(()=>{n&&m.current&&(n.say(r,m.current),t(""))},[n,r,m,t]),h=U(t,f,d),p=Object(a.useCallback)(e=>{t(t=>`${t.trim()} @${e} `.trimLeft()),d.current&&d.current.focus()},[t,d]),A=Object(a.useCallback)(e=>{t(t=>`${t.trim()} ${e} `.trimLeft())},[t]);return u.a.createElement(qt,null,u.a.createElement(Yt,{isFixedWidth:c},r?u.a.createElement(Lt,{onNameRightClick:p}):u.a.createElement(Vt,null),u.a.createElement(Ne,{ref:d,text:e,suggestions:h.suggestions,isDisabled:g,onEmoteClick:A,onChange:h.handleChange,onKeyUp:h.handleKeyUp,onKeyDown:h.handleKeyDown,onBlur:h.handleBlur,onSuggestionMouseEnter:h.handleSuggestionMouseEnter,onSuggestionClick:h.handleSuggestionClick}),u.a.createElement(Ct,{isDisabled:g,onSendMessage:f})))};var Qt=()=>(window.location.href=Object(o.a)(),null);var Xt=()=>{const e=Object(s.f)(),t=Object(i.b)();return localStorage.removeItem(y.c),localStorage.removeItem(y.e),localStorage.removeItem(y.h),t(Object(l.d)()),e.push({pathname:"/chat/",hash:localStorage.getItem(y.f)||""}),null};var en=()=>{const e=Object(s.f)();if(!window.location.hash)return null;const t=new URLSearchParams(window.location.hash.slice(1)),n=t.get("access_token"),a=t.get("id_token");return n&&a?(localStorage.setItem(y.c,n),localStorage.setItem(y.e,a),e.push({pathname:"/chat/",hash:localStorage.getItem(y.f)||""}),null):null},tn=c.b`
  * {
